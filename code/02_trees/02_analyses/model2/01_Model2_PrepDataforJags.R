...
#get treatment from thinned and burned columsn of the tree
#dataset and put in categories

#make sure DBH and BA are from the *previous* survey, not the 
#current one

#UPDATE NOV 2025
#MAKE SURE (maybe not as relevant for this model but)
#DBH is prior dbh 
#BA is prior BA
#Tx category is coming from thinned and burned 
