...
# of the three models for simulated low variability model
...
mod1_GOF <- readRDS(here('data_outputs',
                         'simulated',
                         '04_posterior_summaries',
                         'mod1low_GOFmodel.RDS'))


mod2_GOF <- readRDS(here('data_outputs',
                         'simulated',
                         '04_posterior_summaries',
                         'mod2low_GOFmodel.RDS'))

mod3_GOF <- readRDS(here('data_outputs',
                         'simulated',
                         '04_posterior_summaries',
...
#accuary
#0s:
zeros1 <- round(21/(21+71), digits = 2)*100
#1s:
ones1 <- round(185/(185+23), digits = 2)*100
...
#1s:
ones2 <- round(201/(201+7), digits = 2)*100
#0s:
zeros2 <- round(11/(11+81), digits = 2)*100
...
#accuary
#0s:
zeros3 <- round(22/(22+70), digits = 2)*100#87%
#1s:
ones3 <- round(186/(186+22), digits = 2)*100 #98%
