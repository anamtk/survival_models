...
write.csv(y.med.daily.short, here("data_outputs",
                                  "03_simulated",
                          "02_analysis_ready",
                          "test_med_var_daily_short_data.csv"),
          row.names = F)

write.csv(y.med.daily.long, here("data_outputs",
                                 "03_simulated",
                                  "02_analysis_ready",
                                  "test_med_var_daily_long_data.csv"),
          row.names = F)
...
write.csv(y.med.int.short, here("data_outputs",
                                "03_simulated",
                                "02_analysis_ready",
                                "test_med_var_short_interval_data.csv"),
          row.names =F)

write.csv(y.med.int.long, here("data_outputs",
                               "03_simulated",
                               "02_analysis_ready",
                               "test_med_var_long_interval_data.csv"),
          row.names =F)
