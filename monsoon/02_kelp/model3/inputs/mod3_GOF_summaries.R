...
mod <- readRDS(file = "/scratch/atm234/survival_models/kelp/model3/outputs/model3_JAGS_model.RDS")
...
saveRDS(mod.update, 
        file= "/scratch/atm234/survival_models/kelp/model3/outputs/model3_GOF.RDS")
...
saveRDS(samples_all2, 
        file= "/scratch/atm234/survival_models/kelp/model3/outputs/model3_post_samples.RDS")

summary <- summary(mod$samples)

saveRDS(summary, 
        file= "/scratch/atm234/survival_models/kelp/model3/outputs/model3_posterior_summary.RDS")
