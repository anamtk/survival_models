...
mod <- readRDS(file = "/scratch/atm234/survival_models/model2/outputs/model2_JAGS_model.RDS")
...
saveRDS(mod.update, 
        file= "/scratch/atm234/survival_models/model2/outputs/model2_GOF.RDS")
...
saveRDS(samples_all2, 
        file= "/scratch/atm234/survival_models/model2/outputs/model2_post_samples.RDS")

summary <- summary(mod$samples)

saveRDS(summary, 
        file= "/scratch/atm234/survival_models/model2/outputs/model2_posterior_summary.RDS")
