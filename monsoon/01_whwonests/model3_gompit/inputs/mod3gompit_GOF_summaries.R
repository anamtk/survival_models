...
mod <- readRDS(file = "/scratch/atm234/survival_models/model3_gompit/outputs/model3gompit_JAGS_model.RDS")


# Update for goodness of fit ----------------------------------------------

parms <- c("yrep_1", "yrep_2", 'resid_1', "resid_2", 'p_1', "p_2")
...
saveRDS(mod.update, 
        file= "/scratch/atm234/survival_models/model3_gompit/outputs/model3gompit_GOF.RDS")
...
saveRDS(samples_all2, 
        file= "/scratch/atm234/survival_models/model3_gompit/outputs/model3gompit_post_samples.RDS")

summary <- summary(mod$samples)

saveRDS(summary, 
        file= "/scratch/atm234/survival_models/model3_gompit/outputs/model3gompit_posterior_summary.RDS")
